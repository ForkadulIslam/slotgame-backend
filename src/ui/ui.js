import { drawReelsSymbols, getAnyWin, getCustomScenario, getSymbolWin, play, setCountersValues, } from "./utils.js";
import { getInitialData } from "../data.js";
export const initializeUi = async (div, customScenarios) => {
    ...
    setCountersValues(initialData.credits, initialData.bet, win, initialData.freeGamesNum, initialData.freeGamesSum, initialData.freeGamesBank);
